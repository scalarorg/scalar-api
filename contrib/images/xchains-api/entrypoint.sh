...
BINARY=${BINARY:-/bin/xchains-api}
CONFIG=${CONFIG:-/home/xchains-api/config.yml}
PARAMS=${PARAMS:-/home/xchains-api/global-params.json}
FINALITY_PROVIDERS=${FINALITY_PROVIDERS:-/home/xchains-api/finality-providers.json}
